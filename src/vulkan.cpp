...
void Renderer::setup()
{
	...
	m_albedoTexture = createTexture(Image::fromFile("data/model/knife/blinn1_Base_Color.png"), VK_FORMAT_R8G8B8A8_SRGB);
	m_normalTexture = createTexture(Image::fromFile("data/model/knife/blinn1_Normal.png"), VK_FORMAT_R8G8B8A8_UNORM);
	m_metalnessTexture = createTexture(Image::fromFile("data/model/knife/blinn1_Metallic.png", 1), VK_FORMAT_R8_UNORM);
	m_roughnessTexture = createTexture(Image::fromFile("data/model/knife/blinn1_Roughness.png", 1), VK_FORMAT_R8_UNORM);
